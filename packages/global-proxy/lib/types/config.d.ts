...
export declare const DEFAULT_PROXY = "http://127.0.0.1:7892";
/** Hosts/subdomains that stay direct; see the plugin README for rationale. */
export declare const DEFAULT_NO_PROXY = "localhost,127.0.0.1,[::1],::1,deepseek.com,registry.npmmirror.com";
/** Self-test endpoint used only when explicitly enabled. */
export declare const DEFAULT_SELFTEST_URL = "https://chatgpt.com/backend-api/codex/models";
/** Self-test timeout in milliseconds. */
export declare const SELFTEST_TIMEOUT_MS = 15000;
...
export declare function buildProxyConfig(env?: ProxyEnv): ProxyConfig;
