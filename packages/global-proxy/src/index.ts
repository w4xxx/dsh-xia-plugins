 ...
 */
export function apply(ctx: { logger?: { info?: (m: string) => void; warn?: (m: string) => void } } | undefined): void {
  ...
  const { EnvHttpProxyAgent, setGlobalDispatcher } = req('undici') as typeof import('undici')
